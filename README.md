...
**LLM_BASE_URL**: (Optional) Base URL for your custom OpenAI-compatible LLM API endpoint (e.g., `http://89.169.108.83:30000/v1`). When this is set, Ollama will not be used and you don't need to deploy it.
...
EMBEDDING_MODEL_ID=sentence-transformers/all-mpnet-base-v2
EMBEDDING_SIZE=768
LLM_BASE_URL=http://89.169.108.83:30000/v1 # Your custom LLM endpoint
...
LLM_BASE_URL=http://89.169.108.83:30000/v1
